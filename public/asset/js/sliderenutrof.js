const slider =
{
    ...
    sliderPosition: [
        'position-0-enutrofM.png',   // position 0
        'position-1-enutrofM.png',   // position 1
        'position-2-enutrofM.png',   // position 2
        'position-3-enutrofM.png',   // position 3
        'position-4-enutrofM.png',
        'position-5-enutrofM.png',
        'position-6-enutrofM.png',
        'position-7-enutrofM.png',
    ],

    sliderPositionF: [
        'position-0-enutrofF.png',   // position 0
        'position-1-enutrofF.png',   // position 1
        'position-2-enutrofF.png',   // position 2
        'position-3-enutrofF.png',   // position 3
        'position-4-enutrofF.png',
        'position-5-enutrofF.png',
        'position-6-enutrofF.png',
        'position-7-enutrofF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#794100"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/enutrof/" + image;
