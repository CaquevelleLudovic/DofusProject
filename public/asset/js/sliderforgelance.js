const slider =
{
    ...
    sliderPosition: [
        'position-0-forgelanceM.png',   // position 0
        'position-1-forgelanceM.png',   // position 1
        'position-2-forgelanceM.png',   // position 2
        'position-3-forgelanceM.png',   // position 3
        'position-4-forgelanceM.png',
        'position-5-forgelanceM.png',
        'position-6-forgelanceM.png',
        'position-7-forgelanceM.png',
    ],

    sliderPositionF: [
        'position-0-forgelanceF.png',   // position 0
        'position-1-forgelanceF.png',   // position 1
        'position-2-forgelanceF.png',   // position 2
        'position-3-forgelanceF.png',   // position 3
        'position-4-forgelanceF.png',
        'position-5-forgelanceF.png',
        'position-6-forgelanceF.png',
        'position-7-forgelanceF.png',
    ],
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/forgelance/" + image;
