const slider =
{
    ...
    sliderPosition: [
        'position-0-fecaM.png',   // position 0
        'position-1-fecaM.png',   // position 1
        'position-2-fecaM.png',   // position 2
        'position-3-fecaM.png',   // position 3
        'position-4-fecaM.png',
        'position-5-fecaM.png',
        'position-6-fecaM.png',
        'position-7-fecaM.png',
    ],

    sliderPositionF: [
        'position-0-fecaF.png',   // position 0
        'position-1-fecaF.png',   // position 1
        'position-2-fecaF.png',   // position 2
        'position-3-fecaF.png',   // position 3
        'position-4-fecaF.png',
        'position-5-fecaF.png',
        'position-6-fecaF.png',
        'position-7-fecaF.png',
    ],
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/feca/" + image;
