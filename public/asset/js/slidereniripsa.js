const slider =
{
    ...
    sliderPosition: [
        'position-0-eniripsaM.png',   // position 0
        'position-1-eniripsaM.png',   // position 1
        'position-2-eniripsaM.png',   // position 2
        'position-3-eniripsaM.png',   // position 3
        'position-4-eniripsaM.png',
        'position-5-eniripsaM.png',
        'position-6-eniripsaM.png',
        'position-7-eniripsaM.png',
    ],

    sliderPositionF: [
        'position-0-eniripsaF.png',   // position 0
        'position-1-eniripsaF.png',   // position 1
        'position-2-eniripsaF.png',   // position 2
        'position-3-eniripsaF.png',   // position 3
        'position-4-eniripsaF.png',
        'position-5-eniripsaF.png',
        'position-6-eniripsaF.png',
        'position-7-eniripsaF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        positionBackground.style.backgroundPosition = "50% 5%"

        const BackgroundTitle = document.querySelector(".characName")
        BackgroundTitle.style.background = "#3E171B"
        ...
        loadSliderImages: function() {
            ...
            function addImagesToSlider(imageList) {
              for (const image of imageList) {
                ...
                imageElement.src = "../asset/img/position/eniripsa/" + image;
