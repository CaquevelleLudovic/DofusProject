const slider =
{
    ...
    sliderPosition: [
        'position-0-huppermageM.png',   // position 0
        'position-1-huppermageM.png',   // position 1
        'position-2-huppermageM.png',   // position 2
        'position-3-huppermageM.png',   // position 3
        'position-4-huppermageM.png',
        'position-5-huppermageM.png',
        'position-6-huppermageM.png',
        'position-7-huppermageM.png',
    ],

    sliderPositionF: [
        'position-0-huppermageF.png',   // position 0
        'position-1-huppermageF.png',   // position 1
        'position-2-huppermageF.png',   // position 2
        'position-3-huppermageF.png',   // position 3
        'position-4-huppermageF.png',
        'position-5-huppermageF.png',
        'position-6-huppermageF.png',
        'position-7-huppermageF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        positionBackground.style.backgroundPosition = "50% 10%"

        const BackgroundTitle = document.querySelector(".characName")
        BackgroundTitle.style.background = "#2b1d12"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/huppermage/" + image;
