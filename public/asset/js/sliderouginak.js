const slider =
{
    ...
    sliderPosition: [
        'position-0-ouginakM.png',   // position 0
        'position-1-ouginakM.png',   // position 1
        'position-2-ouginakM.png',   // position 2
        'position-3-ouginakM.png',   // position 3
        'position-4-ouginakM.png',
        'position-5-ouginakM.png',
        'position-6-ouginakM.png',
        'position-7-ouginakM.png',
    ],

    sliderPositionF: [
        'position-0-ouginakF.png',   // position 0
        'position-1-ouginakF.png',   // position 1
        'position-2-ouginakF.png',   // position 2
        'position-3-ouginakF.png',   // position 3
        'position-4-ouginakF.png',
        'position-5-ouginakF.png',
        'position-6-ouginakF.png',
        'position-7-ouginakF.png',
    ],
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/ouginak/" + image;
