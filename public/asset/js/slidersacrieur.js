const slider =
{
    ...
    sliderPosition: [
        'position-0-sacrieurM.png',   // position 0
        'position-1-sacrieurM.png',   // position 1
        'position-2-sacrieurM.png',   // position 2
        'position-3-sacrieurM.png',   // position 3
        'position-4-sacrieurM.png',
        'position-5-sacrieurM.png',
        'position-6-sacrieurM.png',
        'position-7-sacrieurM.png',
    ],

    sliderPositionF: [
        'position-0-sacrieurF.png',   // position 0
        'position-1-sacrieurF.png',   // position 1
        'position-2-sacrieurF.png',   // position 2
        'position-3-sacrieurF.png',   // position 3
        'position-4-sacrieurF.png',
        'position-5-sacrieurF.png',
        'position-6-sacrieurF.png',
        'position-7-sacrieurF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#222a03"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/sacrieur/" + image;
