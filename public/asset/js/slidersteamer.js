const slider =
{
    ...
    sliderPosition: [
        'position-0-steamerM.png',   // position 0
        'position-1-steamerM.png',   // position 1
        'position-2-steamerM.png',   // position 2
        'position-3-steamerM.png',   // position 3
        'position-4-steamerM.png',
        'position-5-steamerM.png',
        'position-6-steamerM.png',
    ...
    loadSliderImages: function()
    {
        ...
        for(const image of slider.sliderPosition) {
            ...
            imageElement.src = "http://localhost:8000/asset/img/position/steamer/" + image;
