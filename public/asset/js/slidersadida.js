const slider =
{
    ...
    sliderPosition: [
        'position-0-sadidaM.png',   // position 0
        'position-1-sadidaM.png',   // position 1
        'position-2-sadidaM.png',   // position 2
        'position-3-sadidaM.png',   // position 3
        'position-4-sadidaM.png',
        'position-5-sadidaM.png',
        'position-6-sadidaM.png',
        'position-7-sadidaM.png',
    ],

    sliderPositionF: [
        'position-0-sadidaF.png',   // position 0
        'position-1-sadidaF.png',   // position 1
        'position-2-sadidaF.png',   // position 2
        'position-3-sadidaF.png',   // position 3
        'position-4-sadidaF.png',
        'position-5-sadidaF.png',
        'position-6-sadidaF.png',
        'position-7-sadidaF.png',
    ],
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/sadida/" + image;
