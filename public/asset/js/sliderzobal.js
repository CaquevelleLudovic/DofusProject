const slider =
{
    ...
    sliderPositionF: [
        'position-0-zobalF.png',   // position 0
        'position-1-zobalF.png',   // position 1
        'position-2-zobalF.png',   // position 2
        'position-3-zobalF.png',   // position 3
        'position-4-zobalF.png',
        'position-5-zobalF.png',
        'position-6-zobalF.png',
        'position-7-zobalF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#3f0607"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/zobal/" + image;
