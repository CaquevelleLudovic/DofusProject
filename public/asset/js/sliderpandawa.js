const slider =
{
    ...
    sliderPosition: [
        'position-0-pandawaM.png',   // position 0
        'position-1-pandawaM.png',   // position 1
        'position-2-pandawaM.png',   // position 2
        'position-3-pandawaM.png',   // position 3
        'position-4-pandawaM.png',
        'position-5-pandawaM.png',
        'position-6-pandawaM.png',
        'position-7-pandawaM.png',
    ],

    sliderPositionF: [
        'position-0-pandawaF.png',   // position 0
        'position-1-pandawaF.png',   // position 1
        'position-2-pandawaF.png',   // position 2
        'position-3-pandawaF.png',   // position 3
        'position-4-pandawaF.png',
        'position-5-pandawaF.png',
        'position-6-pandawaF.png',
        'position-7-pandawaF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#3a060d"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/pandawa/" + image;
