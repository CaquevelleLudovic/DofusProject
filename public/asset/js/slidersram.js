const slider =
{
    ...
    sliderPosition: [
        'position-0-sramM.png',   // position 0
        'position-1-sramM.png',   // position 1
        'position-2-sramM.png',   // position 2
        'position-3-sramM.png',   // position 3
        'position-4-sramM.png',
        'position-5-sramM.png',
        'position-6-sramM.png',
        'position-7-sramM.png',
    ],

    sliderPositionF: [
        'position-0-sramF.png',   // position 0
        'position-1-sramF.png',   // position 1
        'position-2-sramF.png',   // position 2
        'position-3-sramF.png',   // position 3
        'position-4-sramF.png',
        'position-5-sramF.png',
        'position-6-sramF.png',
        'position-7-sramF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#220645"
