const slider =
{
    ...
    sliderPosition: [
        'position-0-xelorM.png',   // position 0
        'position-1-xelorM.png',   // position 1
        'position-2-xelorM.png',   // position 2
        'position-3-xelorM.png',   // position 3
        'position-4-xelorM.png',
        'position-5-xelorM.png',
        'position-6-xelorM.png',
        'position-7-xelorM.png',
    ],

    sliderPositionF: [
        'position-0-xelorF.png',   // position 0
        'position-1-xelorF.png',   // position 1
        'position-2-xelorF.png',   // position 2
        'position-3-xelorF.png',   // position 3
        'position-4-xelorF.png',
        'position-5-xelorF.png',
        'position-6-xelorF.png',
        'position-7-xelorF.png',
    ],
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#030c48"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/xelor/" + image;
