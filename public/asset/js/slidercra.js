const slider =
{
    ...
    sliderPosition: [
        'position-0-craM.png',   // position 0
        'position-1-craM.png',   // position 1
        'position-2-craM.png',   // position 2
        'position-3-craM.png',   // position 3
        'position-4-craM.png',
        'position-5-craM.png',
        'position-6-craM.png',
        'position-7-craM.png',
    ...
    sliderPositionF: [
        'position-0-craF.png',   // position 0
        'position-1-craF.png',   // position 1
        'position-2-craF.png',   // position 2
        'position-3-craF.png',   // position 3
        'position-4-craF.png',
        'position-5-craF.png',
        'position-6-craF.png',
        'position-7-craF.png',
    ...
    stylePage: function()
    {
        ...
        BackgroundTitle.style.background = "#243509"
    ...
    loadSliderImages: function() {
        ...
        function addImagesToSlider(imageList) {
            ...
            imageElement.src = "../asset/img/position/cra/" + image;
